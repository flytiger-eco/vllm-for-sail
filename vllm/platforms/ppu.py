...
class PPUPlatform(NvmlCudaPlatform):
    ...
    def apply_config_platform_defaults(cls, vllm_config: "VllmConfig") -> None:
        ...
        # Enable quant_fp8 CUDA op on PPU: the compiled C++ kernel
        # (dynamic_per_token_scaled_fp8_quant) is faster than the fused
        # triton kernel generated by torch.compile's forward_native path.
