...
mod tests {
    ...
    fn validate_parser_overrides_rejects_unknown_reasoning_parser() {
        ...
        expect_test::expect!["reasoning parser `definitely_missing_reasoning_parser` is not registered (choose from: cohere_cmd, deepseek_r1, deepseek_v3, deepseek_v4, gemma4, glm45, kimi, kimi_k2, minimax_m2, minimax_m3, nemotron_v3, qwen3, step3)"].assert_eq(&error.to_report_string());
    }
}
