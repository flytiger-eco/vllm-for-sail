...
```bash
# 1. Download vLLM 0.20.1
git clone -b v0.20.1 https://github.com/flytiger-eco/vllm-for-sail
...
To use vLLM-for-SAIL directly via Docker or install it from PyPI, please refer to the [vLLM-for-SAIL User Guide](https://www.flytiger-eco.com/docs_center/doc_detail/index.html?projectId=6&documentId=128).
...
```
## More Information
Please refer to the [vLLM-for-SAIL User Guide](https://www.flytiger-eco.com/docs_center/doc_detail/index.html?projectId=6&documentId=128) for more information.
